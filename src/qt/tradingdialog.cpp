...
void tradingDialog::ActionsOnSwitch(int index = -1){
    ...
    switch (index){
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("SAGA");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->FORBalanceLabel,*ui->FORAvailableLabel_2,*ui->FORPendingLabel, QString::fromUtf8("SAGA"),Response);
                    }
                break;
...
void tradingDialog::CalculateCSReceiveLabel(){
    ...
    QString balance = GetBalance("SAGA");
...
void tradingDialog::on_Sell_Max_Amount_clicked()
{
    ...
    QString responseA = GetBalance("SAGA");
    QString str;
