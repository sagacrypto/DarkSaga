...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDarkSagaAmount"))
        settings.setValue("nAnonymizeDarkSagaAmount", 1000);
    nAnonymizeDarkSagaAmount = settings.value("nAnonymizeDarkSagaAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeDarkSagaAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeDarkSagaAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeDarkSagaAmount:
            return QVariant(nAnonymizeDarkSagaAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeDarkSagaAmount:
            nAnonymizeDarkSagaAmount = value.toInt();
            settings.setValue("nAnonymizeDarkSagaAmount", nAnonymizeDarkSagaAmount);
            emit AnonymizeDarkSagaAmountChanged(nAnonymizeDarkSagaAmount);
            break;
        default:
            break;
        }
