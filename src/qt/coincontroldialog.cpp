    ...
    model(0)
{
    ...
    ui->treeWidget->setColumnWidth(COLUMN_SAGASEND_ROUNDS, 120);
...
void CoinControlDialog::updateView()
{
    ...
    BOOST_FOREACH(const PAIRTYPE(QString, std::vector<COutput>)& coins, mapCoins)
    {
        ...
        BOOST_FOREACH(const COutput& out, coins.second)
        {
            ...
            {
                sAddress = QString::fromStdString(CDarkSagaCoinAddress(outputAddress).ToString());
            ...
            if(rounds >= 0) itemOutput->setText(COLUMN_SAGASEND_ROUNDS, strPad(QString::number(rounds), 15, " "));
            else itemOutput->setText(COLUMN_SAGASEND_ROUNDS, strPad(QString(tr("n/a")), 15, " "));
