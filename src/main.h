...
#define START_MASTERNODE_PAYMENTS 1512691200

static const int64_t SAGASEND_COLLATERAL = (0.01*COIN);
static const int64_t SAGASEND_POOL_MAX = (599999.99*COIN);

static const int64_t STATIC_POS_REWARD = 0 * COIN; //Constant reward of 1 SAGA per COIN i.e. 8%
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 500000;
