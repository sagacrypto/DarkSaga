...
#define SAGASEND_QUEUE_TIMEOUT                 30
#define SAGASEND_SIGNING_TIMEOUT               15

// used for anonymous relaying of inputs/outputs/sigs
#define SAGASEND_RELAY_IN                 1
#define SAGASEND_RELAY_OUT                2
#define SAGASEND_RELAY_SIG                3
...
public:
    ...
    bool IsExpired()
    {
        return (GetTime() - addedTime) > SAGASEND_QUEUE_TIMEOUT;// 120 seconds
    }
};
...
public:
    ...
    bool IsExpired()
    {
        return (GetTime() - time) > SAGASEND_QUEUE_TIMEOUT;// 120 seconds
    }
...
{
public:
    /// Is the inputs associated with this public key? (and there is 2500 SAGA - checking if valid masternode)
